    ...
    <div className="bg-primary h-full">
      ...
      >
        ...
        <SwiperSlide
          ...
          style={{
            backgroundImage: 'url(" https://i.ibb.co/hfttbdM/bg2.webp")',
            opacity: ".9",
          }}
        >
          <div className="slider-text ">
        ...
        <SwiperSlide
          ...
          style={{
            backgroundImage:
              'url("https://i.ibb.co/5vpSNTZ/bitcoin-crypto-currency-with-blockchain-technology-illustration-vector.jpg")',
            opacity: ".8",
          }}
        >
          <div className="slider-text ">
