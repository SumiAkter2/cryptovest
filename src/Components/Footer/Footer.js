...
const Footer = () => {
  return (
    <footer>
      <div className="footer grid-rows-2 p-10 bg-primary ">
        <div>
        ...
        <div>
          <span className="footer-title text-xl">Apps</span>
      ...
      <div className="footer footer-start p-10  bg-primary rounded">
        ...
        <div>
          <p>Copyright &copy; 2022 - All right reserved by CryptoVest</p>
        </div>
      </div>
    </footer>
  );
