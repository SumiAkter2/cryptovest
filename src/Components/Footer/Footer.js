...
const Footer = () => {
  return (
    <footer className="footer-bg">
      <footer className="footer grid-cols-3 lg:p-10 p-5">
        <div>
        ...
        <div>
          ...
          <a href='/' className="link link-hover">Log In</a>
      ...
      <footer className="footer grid-cols-2 just lg:px-10 px-5 py-4  mt-2">
        <div className="">
          <div>
          ...
          <div className="grid grid-flow-col gap-4">
            <a href='/'>
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current cursor-pointer hover:fill-blue-500"
              >
